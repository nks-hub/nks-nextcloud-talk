...
void main() {
  ...
  test(
    'the same room is activated once and released by the last holder',
    () async {
      final room = _activeRoomFixture();
      var activations = 0;
      var deletes = 0;
      ...
      expect(
        activations,
        1,
        reason: 'the second holder joins the live session',
      );
      expect(deletes, 0);
      ...
      expect(
        deletes,
        2,
        reason: 'a different room deactivates the previous one',
      );
    },
  );
}
