...
part 'chat_room_read_suppression_test.part.dart';
...
void main() {
  ...
  testWidgets('idle legacy pane sends no notification-clearing reads', (
    tester,
  ) async {
    await _verifySuppressedRootRead(
      tester,
      idleWindow: true,
      supportsSilentFetch: false,
    );
  });

  testWidgets('legacy pane resumes reading after user activity returns', (
    tester,
  ) async {
    await _verifySuppressedRootRead(
      tester,
