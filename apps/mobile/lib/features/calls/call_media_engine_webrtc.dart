...
part 'call_media_engine_webrtc_screen.dart';
...
final class WebRtcCallMediaEngine implements CallMediaEngine {
  ...
  @override
  Future<bool> requestScreenConsent() => _requestScreenConsent();

  @override
  Future<List<CallScreenSource>> screenSources() => _screenSources();

  @override
  Future<CallLocalVideo> openScreen({CallScreenSource? source}) =>
      _openScreen(source: source);
