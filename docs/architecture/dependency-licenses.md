...
| [`sentry_flutter`](https://pub.dev/packages/sentry_flutter) | 8.14.2; archive SHA-256 `5ba2cf40646a77d113b37a07bd69f61bb3ec8a73cbabe5537b05a7c89d2656f8`; LICENSE SHA-256 `a324d0c2ce63dbdce9e77cbd06a13ad77006d6bf3f82ad3affe03b64e27e83d6` | MIT; Copyright 2019 Sentry | Hlášení pádů pouze v našich buildech; bez `SENTRY_DSN` se SDK vůbec neinicializuje. Držené na 8.x záměrně: 9.0 přidala závislost `jni`, jejíž CMake volá `find_package(JNI)` na Windows i Linuxu, takže desktop build bez nainstalovaného JDK přestane fungovat |
...
| [`sentry`](https://pub.dev/packages/sentry) | 8.14.2; archive SHA-256 `599701ca0693a74da361bc780b0752e1abc98226cf5095f6b069648116c896bb`; lokální LICENSE SHA-256 `9873d81def9cebb9598b4a2d0a1ad062b17781c35c25cc04b75a0f62fc8667fd` | BSD-3-Clause; Copyright 2014 The Chromium Authors | Dart jádro vyžadované balíkem `sentry_flutter`; projekt jej volá jen přes něj | Kompatibilní s GPL-3.0-or-later; zdrojový balík a lokální LICENSE ověřeny |
