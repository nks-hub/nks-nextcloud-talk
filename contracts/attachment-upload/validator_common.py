...
REQUIRED_STATE_IDS = {
    ...
    "named-thread-deleted-root-confirms",
    "named-thread-full-root-confirms",
    "named-thread-malformed-root-is-not-confirmation",
    "plain-confirmation-rejects-parent-scope",
    "reauth-pauses-only-account-lane",
    "reply-confirmation-requires-same-room-thread",
