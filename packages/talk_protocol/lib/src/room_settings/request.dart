...
/// unknown room.
///
/// Password protection is applied atomically with the public transition.
final class SetRoomPublicRequest extends RoomAdministrationRequest {
  SetRoomPublicRequest({
    ...
    _validateUserAgent(userAgent, r'$.headers.userAgent');
    if ((password != null && (!public || !creationPasswordAvailable)) ||
        (public &&
            forcePasswords &&
  ...
  @override
  Map<String, String>? get formBody =>
      password == null ? null : UnmodifiableMapView({'password': password!});
