...
void main() {
  test('attachment runtime executes as a release AOT executable', () async {
    final packageRoot = Directory.current.absolute;
    final probe = File(
      '${packageRoot.path}/test/support/attachment_release_probe.dart',
    );
    expect(probe.existsSync(), isTrue);

    final temporaryDirectory = await Directory.systemTemp.createTemp(
      'talk_protocol_attachment_',
    );
    try {
      final executable = File(
        '${temporaryDirectory.path}/attachment_release_probe'
